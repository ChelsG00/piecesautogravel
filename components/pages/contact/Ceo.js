...
const Ceo = ({t}) => {
  return (
    <div>
    <section className=" bg-white pt-12 pb-[52px] lg:w-full lg:mx-auto">
    <div className="pl-5 pr-5">
      <Image src="/img/team-img/team-all-three.jpg" width={800} height={800} alt="Picture of a man standing infront of a white and black background" title="Sebastien Team Picture" className='w-full h-auto lg:w-[500px]'/>
