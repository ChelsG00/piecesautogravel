...
export const Headerhome = ({t, locale}) => {
  return (
    ...
    <div className="absolute top-[300px] left-0 z-40 fadeInLeft-css text-center mx-auto w-full  sm:top-[300px] sm:text-center sm:ml-0">
      ...
      <p className='text-xs text-white mb-14 md:mb-12 lg:text-[20px] '>{t.homeheader.h2}</p>


      <a
        href="https://gravel.ecopieces.ca/"
        target="_blank"
        className='pb-4 pt-4 pl-9 pr-9 rounded-sm uppercase border-solid border-white font-semibold border-[2px] text-white bg-transparent text-xl mr-4 sm:border-white sm:border-2 sm:border-solid sm:bg-[rgba(255,255,255,0.1)] sm:font-semibold sm:tracking-wide sm:text-white z-50'
      >
      {t.links.shop}
      </a>
