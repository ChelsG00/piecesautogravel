          ...
          <h1 className='text-3xl text-[#333333] font-bold'> {t.promos.h1} </h1>
            ...
            <div id="releasesDonate" >
              ...
              <p className='text-xl mb-6 leading-9'>{t.promos.palliatext} {t.buttons.palliasite}</p> 
                <button className='text-xl bg-[#0b54a2] text-white uppercase pt-2 pb-2 pl-8 pr-8 rounded-sm font-semibold'>{t.buttons.pallia}</button> 
            ...
            <div id="careerReleases">
              ...
              <button className='text-xl bg-[#0b54a2] text-white uppercase pt-2 pb-2 pl-8 pr-8 rounded-sm font-semibold'>{t.buttons.careers}</button>
            </div>
