...
const Donate = ({t, locale}) =>  {
  ...
  return (
        <div id="donate"  className="cargroups text-center pt-16 pb-16 pl-5 pr-5 mb-4 rounded-lg sm:px-8 lg:mb-0 lg:w-[100%] lg:ml-0 lg:text-left lg:px-0 lg:pt-1">
                    ...
                    <Link href="https://arpac.org/autopourlavie/" target="_blank">  <button className='text-white text-xl pl-8 pr-8 pt-3 pb-3 mb-2 mt-4 bg-[#0b54a2] rounded w-full lg:w-[20vw] lg:bg-[#ffffff] lg:text-black lg:border-black lg:border-[1px]' >{t.buttons.donate}</button></Link>
                     </div>
  )
}
