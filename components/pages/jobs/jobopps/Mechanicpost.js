...
import MecForm from './forms/MecForm'
import Hamburgerbutton from '../../nav/Hamburgerbutton';

const Mechanicpost = ({t, locale}) => {
  ...
  return (
      ...
      <section>
        <div id="mechanicshortDes" className=" pl-5 pr-5 mt-8 pb-8 border-b-[1px] border-solid border-[#6f6f6f80]">
            <h2 className='mb-1 text-2xl capitalize text-[#303030]'>{t.job.mechanic}</h2>
            <p className='text-xl text-[#181818] mb-2'>{t.job.mectext}</p>
...
// id="mechanicPosForm" class="jobDescriptionPrompt"