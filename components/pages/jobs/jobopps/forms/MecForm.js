...
import Hamburgerbutton from '@/components/pages/nav/Hamburgerbutton';
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      try {
        ...
        setErrors({ form: 'Error submitting application' });
      }
    }
  };
  ...
  return (
    ...
    <div className='mb-10'>
      <div className='pl-5 pr-5'>
        <h1 className='pt-24 pb-3 text-3xl text-center'></h1> {t.mec.h1}
        <p className='text-xl pb-2'>{t.mec.pOne}</p>
        <p className='text-xl pb-2'>{t.mec.pTwo}</p>

        <div className='pt-6 pb-9'>
        <h3 className='text-2xl'>{t.mec.h3}</h3>
                    <ul className='text-xl'>
                        <li className='list-disc pl-2 list-inside'> {t.mec.liOne}</li>
                        <li className='list-disc pl-2 list-inside'>{t.mec.liTwo}</li>
                        <li className='list-disc pl-2 list-inside'>{t.mec.liThree}</li>
                        <li className='list-disc pl-2 list-inside'>{t.mec.liFour}</li>
                    </ul>
        </div>
      </div>
    ...
    <form onSubmit={handleSubmit} className="max-w-md mx-auto pt-3 mb-56">
      ...
      <div className="mb-4">
        <label htmlFor="employmentDate" className="block text-gray-700 text-xl mb-2">
        {t.form.date}
        </label>
        <input
          type="date"
      ...
      <div className="mb-6">
        <label htmlFor="cv" className="block text-gray-700 text-xl mb-2">
        {t.form.cv}
        </label>
        <input
          type="file"
