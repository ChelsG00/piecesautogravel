  ...
  return (
    <div className='mb-10'>
      <div className='pl-5 pr-5'>
        <h1 className='pt-24 pb-3 text-3xl text-center'>{t.shi.h1}</h1>
        <p className='text-xl pb-2'>{t.shi.pOne}</p>
        <p className='text-xl pb-2'>{t.shi.pTwo}</p>

        <div className='pt-6 pb-9'>
        <h3 className='text-2xl'>{t.shi.h3}</h3>
        <ul className='text-xl'>
          <li className='list-disc pl-2 list-inside'>{t.shi.liOne}</li>
          <li className='list-disc pl-2 list-inside'>{t.shi.liTwo}</li>
          <li className='list-disc pl-2 list-inside'>{t.shi.liThree}</li>
          <li className='list-disc pl-2 list-inside'>{t.shi.liFour}</li>
          <li className='list-disc pl-2 list-inside'>{t.shi.liFive}</li>
          <li className='list-disc pl-2 list-inside'>{t.shi.liSix}</li>
        </ul>
        </div>
      </div>
