  ...
  return (
    <div className='mb-10'>
      <div className='pl-5 pr-5'>
        <h1 className='pt-24 pb-3 text-3xl text-center'>{t.sal.h1}</h1>
        <p className='text-xl pb-2'>{t.sal.pOne}</p>
        <p className='text-xl pb-2'>{t.sal.pTwo}</p>

        <div className='pt-6 pb-9'>
        <h3 className='text-2xl'>{t.sal.h3}</h3>
        <ul className='text-xl'>
          <li className='list-disc pl-2 list-inside'>{t.sal.liOne}</li>
          <li className='list-disc pl-2 list-inside'>{t.sal.liTwo}</li>
          <li className='list-disc pl-2 list-inside'>{t.sal.liThree}</li>
          <li className='list-disc pl-2 list-inside'>{t.sal.liFour}</li>
          <li className='list-disc pl-2 list-inside'>{t.sal.liFive}</li>
        </ul>
        </div>
      </div>
