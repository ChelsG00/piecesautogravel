...
const Aboutteam = ({t}) => {
  return (
        ...
        <button className='text-xl pl-8 pr-8 pb-4 pt-4 rounded-sm bg-[#15212d] text-white mb-32 w-[80vw] mx-auto lg:w-[20vw] lg:bg-[rgb(14,58,116)]'>{t.careers.button}</button>
        <div className='lg:flex lg:justify-around'>
          ...
          <div className='relative mb-6'>
            ...
            <div className='absolute top-0 left-0 w-full h-[300px] bg-[#13171cde] text-center flex justify-center items-center lg:bg-[rgba(12,12,12,0.78)]'>
          ...
          <div className='relative mb-6'>
            ...
            <div className='absolute top-0 left-0 w-full h-[300px] bg-[#13171cde] text-center flex justify-center items-center lg:bg-[rgba(19,19,19,0.78)]'>
          ...
          <div className='relative mb-6'>
            ...
            <div className='absolute top-0 left-0 w-full h-[300px] bg-[#13171cde] text-center flex justify-center items-center lg:bg-[rgba(24,24,24,0.78)]'>
