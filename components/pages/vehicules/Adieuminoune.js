...
const AdieuminouneCars = ({t, locale}) => {
 ...
 <div id="byebye" className="cargroups  text-center pt-16 pb-16 pl-5 pr-5 mb-4 rounded-lg sm:px-8 lg:w-full lg:mr-8 lg:text-left lg:pl-0 lg:mb-0 lg:ml-[210px]">
                     ...
                     <div className='flex flex-row items-center justify-center w-full mt-6 mb-10 lg:hidden'>
                       <div className='flex flex-col items-center mb-3 pr-6 lg:mr-6'>
                       ...
                       <div className='flex flex-col items-center pr-6 lg:mr-6'>
                   ...
                   <div className='hidden lg:block lg:mb-[-50px] lg:ml-[-60px]'>
                     ...
                     <Link href="https://adieuminoune.com/prix-auto-feraille" target="_blank"><button className='text-white text-xl pl-8 pr-8 pt-3 pb-3 mb-2 mt-4 bg-[#0b54a2] rounded w-full lg:w-[20vw]' >{t.buttons.quote}</button></Link>
                    </div>
