     ...
     <div>
       <div>
         <div id="installationChoice">
           <legend className='text-[16px] mb-2 mt-16'>CHOISIR UNE OPTION</legend>
           <div className='mb-2'>
             <input
               type="radio"
               id="toggleInstall"
             ...
             />
             <label className='ml-5 text-[16px]'>Avec Installation *Taxes Incluses</label>
           </div>
           <div>
             <input
               type="radio"
               ...
               onChange={handleInstallationChange}
             />
             <label className='ml-5 text-[16px] '>Sans Installation</label>
           </div>
         </div>
           ...
           <div id="toggleWithInstallation">
             ...
             <div>
               <input
                 ...
                 defaultChecked
               />
               <label className='ml-5 text-[16px]'>13-14-15</label>
             </div>
             <div>
               <input
                 type="radio"
                 ...
                 className="colorButton, mb-4"
               />
               <label className='ml-5 text-[16px]'>16-17-18</label>
             </div>
             <div>
               <input
                 type="radio"
                 ...
                 className="colorButton, mb-4"
               />
               <label className='ml-5 text-[16px]'>19-20</label>
             </div>
             <div>
               <input
                 type="radio"
                 ...
                 className="colorButton, mb-4"
               />
               <label className='ml-5 text-[16px]'>21+</label>
             </div>
