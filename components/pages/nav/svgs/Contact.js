...
const Svgcontact = ({ isScrolled }) => {
  return (
    <span className="w-[25px] h-[25px] text-center fill-[#8b8b8b] md:fill-[#333333] lg:w-[20px] lg:flex">
                                <svg version="1.1" id="contactUsIcon" x="0px" y="0px" viewBox="0 0 50 50" >
                                  <path fill={isScrolled ? "lg:#000000" : "lg:#FFFFFF"} d="M1.7,18.77c0.16-0.73,0.29-1.46,0.48-2.18c0.37-1.37,0.95-2.64,1.92-3.71c1.73-1.9,4.23-2.46,6.61-1.49
                                  ...
                                  <path fill={isScrolled ? "lg:#000000" : "lg:#FFFFFF"} d="M48.47,38.27c-0.59,1.21-1.58,1.58-2.88,1.57c-5.67-0.04-11.33-0.02-17-0.02c-0.2,0-0.4,0.01-0.6-0.01
